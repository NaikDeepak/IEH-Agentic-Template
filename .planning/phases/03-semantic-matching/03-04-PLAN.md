...
must_haves:
  ...
  artifacts:
    - path: "src/pages/jobs/JobsPage.tsx"
...
<task type="auto">
  ...
  <files>src/features/jobs/components/JobCard.tsx</files>
  <action>
  ...
  <verify>Component accepts matchScore prop</verify>
  <done>JobCard displays match score</done>
</task>

<task type="auto">
  <name>Task 2: Integrate Search into Jobs Page</name>
  <files>src/pages/jobs/JobsPage.tsx</files>
  <action>
    Refactor `JobsPage.tsx`.
  ...
  <verify>Check logic for switching between service.getJobs and searchJobs</verify>
