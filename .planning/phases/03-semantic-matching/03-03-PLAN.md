...
<task type="auto">
  ...
  <verify>ls src/features/candidates/components/CandidateCard.tsx</verify>
...
<task type="auto">
  ...
  <verify>ls src/pages/employer/TalentSearch.tsx</verify>
...
<task type="auto">
  ...
  <action>
    ...
    2. Add link in `src/components/Header.tsx` (Navbar):
       - Label: "Find Talent"
       - To: "/employer/search"
