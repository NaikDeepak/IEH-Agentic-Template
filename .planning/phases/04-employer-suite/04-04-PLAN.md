...
must_haves:
  truths:
    - "Company editor page loads without errors in the browser"
    - "AI-generated screening questions are correctly parsed and displayed in the UI"
    - "Employer can successfully post a job with AI-generated embeddings"
  artifacts:
