...
<task type="auto">
  <name>Task 1: Implement AI Analysis Logic</name>
  ...
  <verify>grep "generateContent" src/features/seeker/services/resumeService.ts && grep "application/json" src/features/seeker/services/resumeService.ts</verify>
  <done>Reliable AI analysis of resumes returning structured feedback.</done>
</task>
