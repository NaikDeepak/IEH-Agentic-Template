        ...
        <div className="min-h-[80vh] flex items-center justify-center p-4 bg-sky-50 w-full font-sans">
            <div className="max-w-md w-full bg-white rounded-2xl border border-slate-200 shadow-soft p-8 md:p-10">
                ...
                {import.meta.env['VITE_USE_FIREBASE_EMULATOR'] === 'true' ? (
                    <div className="mb-6 p-3 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-700 text-center">
                        Google sign-in is not available in local emulator mode. Use email/password above.
                    </div>
                ) : (
                    <button
